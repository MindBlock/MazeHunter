...
public class TheMazeHard extends Activity{
	...
	private void addMazeButtons(LinearLayout scrollLayout){
		...
		Map<Integer, String> completionMap = this.levelCompletion.getMazeCompletionList().get(2);
	...
	private ImageView getLevelImage(){
		...
		levelImage.setImageResource(R.drawable.image_the_maze_hard);
	...
	public class LevelListener implements OnClickListener{
		...
		public void onClick(View v) {
			...
			Intent intent = new Intent(TheMazeHard.this, TheMaze.class);
			//Add extras?
			intent.putExtra("COMPLETION", this.completion);
			intent.putExtra("LEVEL", this.level);
			intent.putExtra("MAZE_FRAGMENT", 3);
			TheMazeHard.this.startActivity(intent);
		}
	...
	public void onBackPressed(){
		Intent i = new Intent(TheMazeHard.this,TheMazeDifficulties.class);    
		startActivity(i);  
	}
}
